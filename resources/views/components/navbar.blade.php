<nav class="navbar has-background-darl" role="navigation" aria-label="main navigation" x-data="{ show: false }">
    <div class="navbar-brand">
        <a class="navbar-item" href="/">
            <h1 class="title has-text-weight-bold">B-Log</h1>
        </a>

        <a role="button" class="navbar-burger" aria-label="menu" aria-expanded="false" :aria-expanded="show ? 'true' : 'false'"
            @click="show = !show" data-target="navmenu">
